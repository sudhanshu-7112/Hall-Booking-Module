...
from AoRole.views import AllHall, Ao_Pending, Ao_Report, Ao_accepted_rejected, AoApproval, Book_Hall, Department_Names, Halls, Hallsdropdown, Hod_accepted_rejected, Hod_pending_forms, HodApproval, Logout, Panel, Register, Userdetails
